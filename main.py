    ...
    while status:
        ...
        if operation == 1:  # Вставка
            ...
            try:
                ...
                insert = "insert into " + current_bd + " values(" + max_id + ", \'Новая страна " + max_id + \
                                                        "\', \'Глава страны " + max_id + "\', current_timestamp," \
            ...
            try:
                ...
                update = "update " + current_bd + " set head_of_state = \'Обновление главы \' || current_time," \
...
def replicator(number_of_transactions):
    ...
    while status:
        ...
        try:
            ...
            cursor.execute("select count(*) from pmib9505.change_journal where change_time > timestamp \'" + time + "\'")
        ...
        if current_transactions == number_of_transactions:
            replication = "lock table pmib9505.cbd, pmib9505.pbd1, pmib9505.pbd2, pmib9505.change_journal in exclusive mode;\n"
